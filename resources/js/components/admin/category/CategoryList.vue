...
<div class="content">
   <div class="container-fluid">
           ...
           <div class="card">
                <div class="card-header border-0">
                  <div class="d-flex justify-content-between">
                   ...
                   <el-button type="primary" @click="categoryCreate" round>Add New <i class="el-icon-plus"></i></el-button>
     ...
     <template slot-scope="scope">
        ...
        <el-button @click="deleteCategory(scope.row.id)" size="small">Delete</el-button>
      </template>
                        </el-table-column>
                </el-table>
...
<el-dialog
 ...
 :title ="form.id ? 'Edit Category' : 'Add New Category'"
  ...
  <span>
       ...
       <el-form  label-width="120px" @submit="addNewCategory">
